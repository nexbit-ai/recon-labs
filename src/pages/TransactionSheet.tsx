  ...
  const getVisibleColumns = () => {
    if (activeTab === 5) {
      return [
        ...
        'Listing Price', 'GT Charges', 'Gross Amount (Price before discount)', 'Platform Discount', 'Taxable Value', 'Output GST', 'Net Invoice', 
                                ...
                                {getCurrentColumns().map((column, colIndex) => {
                                  ...
                                  if (activeTab === 4) {
                                    ...
                                    const mapping: Record<string, string> = {
                                      ...
                                      'Gross Amount (Price before discount)': 'gross_amount',
                                      ...
                                      'Collection Fees': 'collection_fee',
                                      'Pick & Pack Fees': 'pick_and_pack_fee',
                                      'Total MP Commission': 'total_mp_commission',
                                      'Return Shipping': 'return_shipping_fee',
                                      'Reverse Shipping': 'reverse_shipping_fee',
                                      'Return Fixed Fees': 'return_fixed_fee',
                                      'Return Collection Fees': 'return_collection_fee',
                                      'Return Pick & Pack': 'return_pick_and_pack_fee',
                                      'Total Cost of Returns': 'total_cost_of_returns',
                                      'Total Cost Incl GT': 'total_cost_incl_gt',
                                      'Tax/TDS/TCS': 'tax_tds_tcs',
                                      ...
                                      'GT% on Listing Fee': 'gt_percentage',
                                      'COB % on Listing Fee': 'cob_percentage',
                                      'Tax%': 'tax_percentage',
                                      'Bank Settlement %': 'bank_settlement_percentage',
                                      'Revenue': 'revenue',
