...
const RowDetail: React.FC<{ po: ReconPurchaseOrder }> = ({ po }) => {
  ...
  return (
    ...
    >
      {/* Table Header */}
      <Box sx={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', px: `${space.md}px`, pb: `${space.sm}px`, borderBottom: hairline }}>
        <Typography sx={{ fontSize: 11, fontWeight: 600, color: colors.grey700, textTransform: 'uppercase' }}>Item</Typography>
        <Typography sx={{ fontSize: 11, fontWeight: 600, color: colors.grey700, textTransform: 'uppercase' }}>Ref</Typography>
        ...
        return (
          <Box key={line.id} sx={{ bgcolor: colors.paper, border: hairline, transition: 'all 0.2s', '&:hover': { borderColor: colors.ink } }}>
            ...
            >
              ...
              <Typography sx={{ fontSize: 13, color: colors.grey700 }}>{line.ref}</Typography>
