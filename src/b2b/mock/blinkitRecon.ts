...
// Expected = 18,34,000
const heroActual = 15_86_000;
const heroDifference = heroExpected - heroActual; // 2,48,000 ✓
...
export const blinkitExceptions: BkException[] = [
  {
    ...
    detail: {
      ...
      actual: 0,
      difference: 43_440,
      explanation: 'Debit note DN-0847 deducted ₹43,440 for damages not reported in GRN acceptance.',
      relatedRecords: [
        { label: 'Invoice', ref: 'INV-BLK-0847', amount: 4_50_000 },
        { label: 'Debit Note', ref: 'DN-0847', amount: 43_440 },
      ],
    },
  },
  {
    ...
    title: 'Pending GRN / Outstanding',
    amount: 2_48_000,
    source: 'Multiple Invoices',
    settlementId: 'BLK-SET-1025',
    status: 'Open',
    suggestedAction: 'Follow up with Blinkit finance for outstanding settlement amounts.',
    detail: {
      expected: 2_48_000,
      actual: 0,
      difference: 2_48_000,
      explanation: 'Unsettled amount held back against expected payout.',
      relatedRecords: [
        { label: 'Pending Value', ref: 'UNSETTLED', amount: 2_48_000 },
      ],
    },
  },
  {
    ...
    title: 'Excess Commission Deducted',
    amount: 59_000,
    source: 'Settlement 1025',
    settlementId: 'BLK-SET-1025',
    status: 'Needs Review',
    suggestedAction: 'Flag to Blinkit category manager. Contract explicitly states 20% margin, not 22%.',
    detail: {
      expected: 59_000,
      actual: 0,
      difference: 59_000,
      explanation: 'Charged 22% margin instead of the contracted 20%.',
      relatedRecords: [
        { label: 'Contract Ref', ref: 'BLK-CTR-FY26', amount: 0 },
      ],
    },
  },
  {
    id: 'EXC-004',
    type: 'Unauthorized Deduction',
    title: 'Unauthorized Cold Storage',
    amount: 49_560,
    source: 'Settlement 1025',
    settlementId: 'BLK-SET-1025',
    status: 'Needs Review',
    suggestedAction: 'Dispute storage fee. Products do not require cold storage per master catalog.',
    detail: {
      expected: 49_560,
      actual: 0,
      difference: 49_560,
      explanation: 'Cold storage charges levied on non-perishable FMCG items.',
      relatedRecords: [
        { label: 'Storage Fee', ref: 'DED-STR-01', amount: 49_560 },
      ],
    },
  },
];
